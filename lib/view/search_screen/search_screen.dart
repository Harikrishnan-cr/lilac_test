            ...
            return Padding(
              ...
              child: Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Text('${controler.mapData[index].key} : ',style: CommonTextStyle.searchFeildTextStyle,),
                    Text('${controler.mapData[index].value}',style: CommonTextStyle.searchFeildTextStyle,) 
                  ],
                ),
              ),
              ),
